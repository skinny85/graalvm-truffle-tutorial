package com.endoflineblog.truffle.part_17.nodes.exprs.arrays;
...
import com.endoflineblog.truffle.part_17.nodes.exprs.properties.CommonWritePropertyNode;
...
public abstract class ArrayIndexWriteExprNode extends EasyScriptExprNode {
    ...
    protected Object writeTruffleStringPropertyCached(
            ...
            @Cached @Shared @SuppressWarnings("unused") TruffleString.EqualNode equalNode,
            ...
            @Cached @Shared CommonWritePropertyNode commonWritePropertyNode) {
