...
public abstract class SelfSpecializingAdditionConcatenationOpNode extends AbstractAdditionConcatenationOpNode {
    @Specialization(rewriteOn = ArithmeticException.class, insertBefore = "concatenateTruffleStrings")
