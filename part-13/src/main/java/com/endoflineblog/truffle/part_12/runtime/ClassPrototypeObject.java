 ...
 * passed to the {@link com.endoflineblog.truffle.part_12.nodes.exprs.objects.ClassDeclExprNode class declaration Node},
 * and saved as a global variable with the name equal to the name of the class using the
 * {@link com.endoflineblog.truffle.part_12.nodes.stmts.variables.GlobalVarDeclStmtNode}.
 */
