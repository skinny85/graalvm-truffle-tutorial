package com.endoflineblog.truffle.part_15.nodes.stmts.variables;
 ...
 * the only difference is passing the name of the function to the constructor of
 * {@link StmtBlockRootNode}.
 */
...
public abstract class FuncDeclStmtNode extends EasyScriptStmtNode {
    ...
    protected Object declareFunction(DynamicObject containerObject,
        ...
        putConstantNode.executeWithFlags(containerObject, this.getFuncName(), this.cachedFunction, 0);
