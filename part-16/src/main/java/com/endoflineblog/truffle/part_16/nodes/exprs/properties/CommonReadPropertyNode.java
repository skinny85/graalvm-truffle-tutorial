package com.endoflineblog.truffle.part_16.nodes.exprs.properties;
...
public abstract class CommonReadPropertyNode extends EasyScriptNode {
    ...
    protected Object readPropertyOfUndefined(
            ...
            @Cached(value = "currentLanguageContext().shapesAndPrototypes") @SuppressWarnings("truffle-neverdefault") ShapesAndPrototypes shapesAndPrototypes) {
