package com.endoflineblog.truffle.part_14.nodes.exprs;

import com.endoflineblog.truffle.part_14.EasyScriptTypeSystem;
import com.endoflineblog.truffle.part_14.EasyScriptTypeSystemGen;
...
public abstract class EasyScriptExprNode extends EasyScriptNode {
     ...
     * Used in {@link com.endoflineblog.truffle.part_14.nodes.exprs.functions.FunctionCallExprNode},
     * alongside {@link #evaluateAsFunction}.
     * The default implementation returns {@link Undefined#INSTANCE},
     * and is overridden only in {@link com.endoflineblog.truffle.part_14.nodes.exprs.properties.PropertyReadExprNode}
     * and {@link com.endoflineblog.truffle.part_14.nodes.exprs.arrays.ArrayIndexReadExprNode}.
     */
