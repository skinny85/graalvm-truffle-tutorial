 ...
 * the only difference is the new {@link #toStringOfMaybeString} method.
 */
public final class EasyScriptTruffleStrings {
     ...
     * Used in {@link com.endoflineblog.truffle.part_14.nodes.exprs.strings.ReadTruffleStringPropertyNode}.
     */
