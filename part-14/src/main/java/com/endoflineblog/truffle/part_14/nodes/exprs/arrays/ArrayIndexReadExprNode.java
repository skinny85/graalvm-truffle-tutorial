package com.endoflineblog.truffle.part_14.nodes.exprs.arrays;
...
import com.endoflineblog.truffle.part_14.nodes.exprs.properties.CommonReadPropertyNode;
 ...
 * the only difference is the special treatment of {@link SuperExprNode}
 * in {@link #evaluateAsFunction}
 * (where we search for the given property in the parent prototype of the current class,
 * instead of in the current object).
 */
@NodeChild("arrayExpr")
@NodeChild("indexExpr")
